...
<b>Send me any Telegram file and reply to that file with /rename NewName.extn</b>"""
    ...
    UPGRADE_TEXT = "CONTACT @tnmaza_support"
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "**Thank you for Using Me > ©  @tnmaza_support **"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds"
    NOT_AUTH_USER_TEXT = "CONTACT @tnmaza_support"
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @tnmaza_support"
